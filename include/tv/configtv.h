...
#define TVCONFIG_TVSRC "../../include /home/pi/Downloads/tvision/include /usr/include/rhtvision "
#define TVCONFIG_RHIDE_OS_LIBS "stdc++ ncurses m gpm X11 Xmu"
#define TVCONFIG_TVOBJ "/usr/lib ../../makes /home/pi/Downloads/tvision/makes /usr/X11R6/lib "
#define TVCONFIG_STDCPP_LIB "-lstdc++"
#define TVCONFIG_SHARED_CODE_OPTION "-fPIC"
#define TVCONFIG_RHIDE_LDFLAGS ""
#define TVCONFIG_RHIDE_LIBS "-L/usr/X11R6/lib -lX11 -lXmu -lgpm -lncurses -lstdc++ -lm -lc"
...
#define TVCONFIG_REF_DIR  "/home/pi/Downloads/tvision"
